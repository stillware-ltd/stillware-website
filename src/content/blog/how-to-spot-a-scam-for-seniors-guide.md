---
heroImage: "/blog/images/how-to-spot-a-scam-for-seniors-guide/hero.png"
...
![The psychological playbook of a scam call](/blog/images/how-to-spot-a-scam-for-seniors-guide/image-01.svg)
...
*   **The Hook:** “Grandma? It’s me.” The voice might sound muffled, stressed, or vaguely like a grandchild. They’ll often use a generic name like “grandpa” so you fill in the blank. If you say, “Michael?” they become Michael.
*   **The Line:** “I’m in trouble. I was in a car accident.” Or “I’m in jail and I need bail money. Please don’t tell mom and dad, I’m so embarrassed.” The details are urgent, emotional, and secret.
*   **The Sinker:** They need money wired via Western Union or MoneyGram immediately, or they need you to buy gift cards (like iTunes or Google Play) and read the codes over the phone. They’ll have a “lawyer” or “police officer” get on the phone to make it official.
...
*   **The Hook:** A pop-up appears on your computer screen, or you get an unsolicited phone call. It looks or sounds incredibly official: “Microsoft Security Alert” or “Apple Support.” It claims your computer is infected with viruses and is sending error reports.
*   **The Line:** “Your personal data and banking information are at extreme risk. We must clean your computer immediately to prevent identity theft.” They create a vivid, terrifying consequence for inaction.
*   **The Sinker:** They instruct you to download a program that gives them remote access to your computer. Once in, they can “show” you fake problems in your system files, steal any data on the spot, or install malware. They often demand a hefty “service fee” to fix the problems they invented.

**Legitimate companies like Microsoft or Apple will never, ever proactively call you about a problem on your computer.**

![Identifying a fake tech support pop-up vs. a real system alert](/blog/images/how-to-spot-a-scam-for-seniors-guide/image-02.svg)
...
![The verification drill for an urgent call](/blog/images/how-to-spot-a-scam-for-seniors-guide/image-03.svg)
...
*   **Suspicious Sender Addresses:** `service@amazon-security.com` (not `@amazon.com`). `support@apple.help-desk.net` (not `@apple.com`). Scammers use addresses that look close.
*   **Generic Greetings:** “Dear Valued Customer” instead of your name.
*   **Urgent, Threatening Language:** “Your account will be closed within 24 hours!” “Immediate action required!”
*   **Mismatched Links:** Hover over (don’t click!) a link. The text might say “www.yourbank.com/login” but the actual destination URL shown in your browser’s status bar will be something completely different like “www.bank-security-verify.ru”.
*   **Poor Grammar and Spelling:** Obvious mistakes are a hallmark of mass phishing campaigns.

**In Phone Calls:**
*   **Robocalls** that prompt you to “Press 1” to speak to an agent.
*   **Caller ID Spoofing:** The number looks local or even matches the first digits of your own number, or appears to be from a legitimate agency. Don’t trust caller ID.
*   **Background Noise** that sounds like a busy call center.
*   **Immediate Requests for Personal Information** (Social Security number, full bank account number, mother’s maiden name).
*   **Resistance to Verification:** If you say you’ll call them back, they become angry, insist there’s no time, or claim the issue is too severe.

![Key red flags across different scam formats](/blog/images/how-to-spot-a-scam-for-seniors-guide/image-04.svg)
