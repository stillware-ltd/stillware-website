...
![The architecture of trust vs. surveillance](/blog/images/why-kids-deserve-digital-privacy/image-01.svg)
...
*   **Local Encryption as a Lock:** The diary should be encrypted with a key only the child knows. Not a parent’s master key. This teaches a fundamental principle: you own your thoughts.
*   **The Decoy Mode (The Empty Notebook):** This is a genius feature for social pressure. If a sibling demands to see the diary, the child can enter a decoy password to open a boring, empty notebook. It preserves privacy without creating a confrontational secret.
*   **Zero Cloud Uploads:** This is the critical architectural guarantee. The journal never leaves the device unless the child explicitly exports it. No startup’s server ever holds a page of it. This eliminates the risk of a data breach exposing a decade of childhood introspection to the internet.
...
![The flow of trust in different models](/blog/images/why-kids-deserve-digital-privacy/image-02.svg)
